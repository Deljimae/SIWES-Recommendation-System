...
const { getCompanyApplications, updateCompanyAplications } = require('../../controllers/company/Applications')

router.post('/login', signIn);
router.post('/register', signUp);

router.put('/update-applications/:id', authMiddleware.verifyToken, updateCompanyAplications);
